...
static ConVar r_flashlightfov( "r_flashlightfov", "179.9", FCVAR_CHEAT ); //45.0
static ConVar r_flashlightoffsetx( "r_flashlightoffsetx", "0.0", FCVAR_CHEAT ); //10.0
static ConVar r_flashlightoffsety( "r_flashlightoffsety", "0.0", FCVAR_CHEAT ); //-20.0
static ConVar r_flashlightoffsetz( "r_flashlightoffsetz", "90.0", FCVAR_CHEAT ); //24.0"
...
static ConVar r_flashlightconstant( "r_flashlightconstant", "0.0", FCVAR_CHEAT ); //maybe .2?
static ConVar r_flashlightlinear( "r_flashlightlinear", "150.0", FCVAR_CHEAT ); //100.0
